...
@section('title', 'Tambah Data (Penghantar)')

@section('content_header')
<h1>Tambah Data (Penghantar)</h1>
@stop

@section('content')
    <div class="container-fluid">
        <form role="form" method="POST" action="{{ route('data.penghantar.store') }}">
            @csrf
            <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <label>Fasa R</label>
                                        <input type="number" step="0.0001" class="form-control" id="wks_fasa_r_setting" onchange="change()" value="{{ old('wks_fasa_r_setting') }}" name="wks_fasa_r_setting" placeholder="Fasa R ...">
                                        Ampere
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <label>Fasa S</label>
                                        <input type="number" step="0.0001" class="form-control" id="wks_fasa_s_setting" onchange="change()" value="{{ old('wks_fasa_s_setting') }}" name="wks_fasa_s_setting" placeholder="Fasa S ...">
                                        Ampere
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <label>Fasa T</label>
                                        <input type="number" step="0.0001" class="form-control" id="wks_fasa_t_setting" onchange="change()" value="{{ old('wks_fasa_t_setting') }}" name="wks_fasa_t_setting" placeholder="Fasa T ...">
                                        Ampere
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <label>GFR</label>
                                        <input type="number" step="0.0001" class="form-control" id="wks_fasa_gfr_setting" onchange="change()" value="{{ old('wks_fasa_gfr_setting') }}" name="wks_fasa_gfr_setting" placeholder="GFR ...">
                                        Ampere
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <label>Fasa R</label>
                                        <input type="number" step="0.0001" class="form-control" id="wks_fasa_r_arus_uji" onchange="change()" value="{{ old('wks_fasa_r_arus_uji') }}" name="wks_fasa_r_arus_uji" placeholder="Fasa R ...">
                                        Ampere
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <label>Fasa S</label>
                                        <input type="number" step="0.0001" class="form-control" id="wks_fasa_s_arus_uji" onchange="change()" value="{{ old('wks_fasa_s_arus_uji') }}" name="wks_fasa_s_arus_uji" placeholder="Fasa S ...">
                                        Ampere
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <label>Fasa T</label>
                                        <input type="number" step="0.0001" class="form-control" id="wks_fasa_t_arus_uji" onchange="change()" value="{{ old('wks_fasa_t_arus_uji') }}" name="wks_fasa_t_arus_uji" placeholder="Fasa T ...">
                                        Ampere
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <label>GFR</label>
                                        <input type="number" step="0.0001" class="form-control" id="wks_fasa_gfr_arus_uji" onchange="change()" value="{{ old('wks_fasa_gfr_arus_uji') }}" name="wks_fasa_gfr_arus_uji" placeholder="GFR ...">
                                        Ampere
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <label>Fasa R</label>
                                        <input type="number" step="0.0001" class="form-control" id="wks_fasa_r_waktu_kerja" onchange="change()" value="{{ old('wks_fasa_r_waktu_kerja') }}" name="wks_fasa_r_waktu_kerja" placeholder="Fasa R ...">
                                        sekon
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <label>Fasa S</label>
                                        <input type="number" step="0.0001" class="form-control" id="wks_fasa_s_waktu_kerja" onchange="change()" value="{{ old('wks_fasa_s_waktu_kerja') }}" name="wks_fasa_s_waktu_kerja" placeholder="Fasa S ...">
                                        sekon
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <label>Fasa T</label>
                                        <input type="number" step="0.0001" class="form-control" id="wks_fasa_t_waktu_kerja" onchange="change()" value="{{ old('wks_fasa_t_waktu_kerja') }}" name="wks_fasa_t_waktu_kerja" placeholder="Fasa T ...">
                                        sekon
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <label>GFR</label>
                                        <input type="number" step="0.0001" class="form-control" id="wks_fasa_gfr_waktu_kerja" onchange="change()" value="{{ old('wks_fasa_gfr_waktu_kerja') }}" name="wks_fasa_gfr_waktu_kerja" placeholder="GFR ...">
                                        sekon
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div class="form-group">
                                                <label>Moment</label>
                                                <input type="number" step="0.0001" class="form-control" id="sar_fasa_r_posisi_moment" readonly value="{{ old('sar_fasa_r_posisi_moment') }}" name="sar_fasa_r_posisi_moment" placeholder="Moment ...">
                                                Ampere
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" step="0.0001" class="form-control" id="sar_fasa_r_hasil_moment_a" readonly value="{{ old('sar_fasa_r_hasil_moment_a') }}" name="sar_fasa_r_hasil_moment_a" placeholder="Moment (Ampere) ...">
                                                Ampere
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" step="0.0001" class="form-control" id="sar_fasa_r_hasil_moment_det" readonly value="{{ old('sar_fasa_r_hasil_moment_det') }}" name="sar_fasa_r_hasil_moment_det" placeholder="Moment (detik) ...">
                                                detik
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div class="form-group">
                                                <label>Moment</label>
                                                <input type="number" step="0.0001" class="form-control" id="sar_fasa_s_posisi_moment" readonly value="{{ old('sar_fasa_s_posisi_moment') }}" name="sar_fasa_s_posisi_moment" placeholder="Moment ...">
                                                Ampere
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div class="form-group">
                                                <label>Moment (Ampere)</label>
                                                <input type="number" step="0.0001" class="form-control" id="sar_fasa_s_hasil_moment_a" readonly value="{{ old('sar_fasa_s_hasil_moment_a') }}" name="sar_fasa_s_hasil_moment_a" placeholder="Moment (Ampere) ...">
                                                Ampere
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            ...
                                            <div class="form-group">
                                                <label>Moment (detik)</label>
                                                <input type="number" step="0.0001" class="form-control" id="sar_fasa_s_hasil_moment_det" readonly value="{{ old('sar_fasa_s_hasil_moment_det') }}" name="sar_fasa_s_hasil_moment_det" placeholder="Moment (detik) ...">
                                                detik
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div class="form-group">
                                                <label>Moment</label>
                                                <input type="number" step="0.0001" class="form-control" id="sar_fasa_t_posisi_moment" readonly value="{{ old('sar_fasa_t_posisi_moment') }}" name="sar_fasa_t_posisi_moment" placeholder="Moment ...">
                                                Ampere
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div class="form-group">
                                                <label>Moment (Ampere)</label>
                                                <input type="number" step="0.0001" class="form-control" id="sar_fasa_t_hasil_moment_a" readonly value="{{ old('sar_fasa_t_hasil_moment_a') }}" name="sar_fasa_t_hasil_moment_a" placeholder="Moment (Ampere) ...">
                                                Ampere
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            ...
                                            <div class="form-group">
                                                <label>Moment (detik)</label>
                                                <input type="number" step="0.0001" class="form-control" id="sar_fasa_t_hasil_moment_det" readonly value="{{ old('sar_fasa_t_hasil_moment_det') }}" name="sar_fasa_t_hasil_moment_det" placeholder="Moment (detik) ...">
                                                detik
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div class="form-group">
                                                <label>Moment</label>
                                                <input type="number" step="0.0001" class="form-control" id="sar_fasa_gfr_posisi_moment" readonly value="{{ old('sar_fasa_gfr_posisi_moment') }}" name="sar_fasa_gfr_posisi_moment" placeholder="Moment ...">
                                                Ampere
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div class="form-group">
                                                <label>Moment (Ampere)</label>
                                                <input type="number" step="0.0001" class="form-control" id="sar_fasa_gfr_hasil_moment_a" readonly value="{{ old('sar_fasa_gfr_hasil_moment_a') }}" name="sar_fasa_gfr_hasil_moment_a" placeholder="Moment (Ampere) ...">
                                                Ampere
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            ...
                                            <div class="form-group">
                                                <label>Moment (detik)</label>
                                                <input type="number" step="0.0001" class="form-control" id="sar_fasa_gfr_hasil_moment_det" readonly value="{{ old('sar_fasa_gfr_hasil_moment_det') }}" name="sar_fasa_gfr_hasil_moment_det" placeholder="Moment (detik) ...">
                                                detik
                                            </div>
                                        </div>
