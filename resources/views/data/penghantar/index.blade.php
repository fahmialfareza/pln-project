...
@section('title', 'Lihat Data (Penghantar)')

@section('content_header')
<h1>Lihat Data (Penghantar)</h1> <br>
@if (session('status'))
    ...
    <div class="col-12">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Lihat Data (Penghantar)</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                            ...
                            <table id="data" class="table table-bordered table-hover dataTable dtr-inline" role="grid" aria-describedby="data_info">
                                ...
                                <tbody>
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td>
                                            <a target="_blank" href="{{ route('data.penghantar.print', $dat->id) }}" class="btn btn-primary"><i class="fas fa-print"></i></a>
                                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-show-{{ $dat->id }}">
                                                Lihat
                                            </button>
                                            <a href="{{ route('data.penghantar.edit', $dat->id) }}" class="btn btn-primary">
                                                Edit
                                            </a>
                                                ...
                                                <div class="modal-dialog modal-xl">
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">DOCP-ID-{{ $dat->id }}</h4>
                                                                            ...
                                                                            <div class="card-body">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-sm-3">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            <label>Fasa R</label>
                                                                                            <input type="number" class="form-control" value="{{ $dat->wks_fasa_r_setting }}" name="wks_fasa_r_setting" placeholder="Fasa R ..."
                                                                                              readonly>
                                                                                            Ampere
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-sm-3">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            <label>Fasa S</label>
                                                                                            <input type="number" class="form-control" value="{{ $dat->wks_fasa_s_setting }}" name="wks_fasa_s_setting" placeholder="Fasa S ..."
                                                                                              readonly>
                                                                                            Ampere
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-sm-3">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            <label>Fasa T</label>
                                                                                            <input type="number" class="form-control" value="{{ $dat->wks_fasa_t_setting }}" name="wks_fasa_t_setting" placeholder="Fasa T ..."
                                                                                              readonly>
                                                                                            Ampere
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-sm-3">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            <label>Fasa GFR</label>
                                                                                            <input type="number" class="form-control" value="{{ $dat->wks_fasa_gfr_setting }}" name="wks_fasa_gfr_setting" placeholder="Fasa GFR ..."
                                                                                              readonly>
                                                                                            Ampere
                                                                                        </div>
                                                                                    </div>
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-sm-3">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            <label>Fasa R</label>
                                                                                            <input type="number" class="form-control" value="{{ $dat->wks_fasa_r_arus_uji }}" name="wks_fasa_r_arus_uji" placeholder="Fasa R ..."
                                                                                              readonly>
                                                                                            Ampere
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-sm-3">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            <label>Fasa S</label>
                                                                                            <input type="number" class="form-control" value="{{ $dat->wks_fasa_s_arus_uji }}" name="wks_fasa_s_arus_uji" placeholder="Fasa S ..."
                                                                                              readonly>
                                                                                            Ampere
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-sm-3">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            <label>Fasa T</label>
                                                                                            <input type="number" class="form-control" value="{{ $dat->wks_fasa_t_arus_uji }}" name="wks_fasa_t_arus_uji" placeholder="Fasa T ..."
                                                                                              readonly>
                                                                                            Ampere
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-sm-3">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            <label>Fasa GFR</label>
                                                                                            <input type="number" class="form-control" value="{{ $dat->wks_fasa_gfr_arus_uji }}" name="wks_fasa_gfr_arus_uji" placeholder="Fasa GFR ..."
                                                                                              readonly>
                                                                                            Ampere
                                                                                        </div>
                                                                                    </div>
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-sm-3">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            <label>Fasa R</label>
                                                                                            <input type="number" class="form-control" value="{{ $dat->wks_fasa_r_waktu_kerja }}" name="wks_fasa_r_waktu_kerja" placeholder="Fasa R ..."
                                                                                              readonly>
                                                                                            sekon
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-sm-3">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            <label>Fasa S</label>
                                                                                            <input type="number" class="form-control" value="{{ $dat->wks_fasa_s_waktu_kerja }}" name="wks_fasa_s_waktu_kerja" placeholder="Fasa S ..."
                                                                                              readonly>
                                                                                            sekon
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-sm-3">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            <label>Fasa T</label>
                                                                                            <input type="number" class="form-control" value="{{ $dat->wks_fasa_t_waktu_kerja }}" name="wks_fasa_t_waktu_kerja" placeholder="Fasa T ..."
                                                                                              readonly>
                                                                                            sekon
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-sm-3">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            <label>Fasa GFR</label>
                                                                                            <input type="number" class="form-control" value="{{ $dat->wks_fasa_gfr_waktu_kerja }}" name="wks_fasa_gfr_waktu_kerja"
                                                                                    ...
                                                                                    <div class="col-sm-6">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-sm-3">
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                    <label>Moment</label>
                                                                                                    <input type="number" class="form-control" value="{{ $dat->sar_fasa_r_posisi_moment }}" name="sar_fasa_r_posisi_moment" placeholder="Moment ..."
                                                                                                      readonly>
                                                                                                    Ampere
                                                                                                </div>
                                                                                            </div>
                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-sm-3">
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <input type="number" class="form-control" value="{{ $dat->sar_fasa_r_hasil_moment_a }}" name="sar_fasa_r_hasil_moment_a"
                                                                                                      placeholder="Moment (Ampere) ..." readonly>
                                                                                                    Ampere
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-sm-3">
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <input type="number" class="form-control" value="{{ $dat->sar_fasa_r_hasil_moment_det }}" name="sar_fasa_r_hasil_moment_det"
                                                                                                      placeholder="Moment (detik) ..." readonly>
                                                                                                    detik
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="col-sm-6">
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-sm-3">
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                    <label>Moment</label>
                                                                                                    <input type="number" class="form-control" value="{{ $dat->sar_fasa_s_posisi_moment }}" name="sar_fasa_s_posisi_moment" placeholder="Moment ..."
                                                                                                      readonly>
                                                                                                    Ampere
                                                                                                </div>
                                                                                            </div>
                                                                                    ...
                                                                                    <div class="col-sm-6">
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-sm-3">
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                    <label>Moment (Ampere)</label>
                                                                                                    <input type="number" class="form-control" value="{{ $dat->sar_fasa_s_hasil_moment_a }}" name="sar_fasa_s_hasil_moment_a"
                                                                                                      placeholder="Moment (Ampere) ..." readonly>
                                                                                                    Ampere
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-sm-3">
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                    <label>Moment (detik)</label>
                                                                                                    <input type="number" class="form-control" value="{{ $dat->sar_fasa_s_hasil_moment_det }}" name="sar_fasa_s_hasil_moment_det"
                                                                                                      placeholder="Moment (detik) ..." readonly>
                                                                                                    detik
                                                                                                </div>
                                                                                            </div>
                                                                                    ...
                                                                                    <div class="col-sm-6">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-sm-3">
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                    <label>Moment</label>
                                                                                                    <input type="number" class="form-control" value="{{ $dat->sar_fasa_t_posisi_moment }}" name="sar_fasa_t_posisi_moment" placeholder="Moment ..."
                                                                                                      readonly>
                                                                                                    Ampere
                                                                                                </div>
                                                                                            </div>
                                                                                    ...
                                                                                    <div class="col-sm-6">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-sm-3">
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                    <label>Moment (Ampere)</label>
                                                                                                    <input type="number" class="form-control" value="{{ $dat->sar_fasa_t_hasil_moment_a }}" name="sar_fasa_t_hasil_moment_a"
                                                                                                      placeholder="Moment (Ampere) ..." readonly>
                                                                                                    Ampere
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-sm-3">
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                    <label>Moment (detik)</label>
                                                                                                    <input type="number" class="form-control" value="{{ $dat->sar_fasa_t_hasil_moment_det }}" name="sar_fasa_t_hasil_moment_det"
                                                                                                      placeholder="Moment (detik) ..." readonly>
                                                                                                    detik
                                                                                                </div>
                                                                                            </div>
                                                                                    ...
                                                                                    <div class="col-sm-6">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-sm-3">
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                    <label>Moment</label>
                                                                                                    <input type="number" class="form-control" value="{{ $dat->sar_fasa_gfr_posisi_moment }}" name="sar_fasa_gfr_posisi_moment" placeholder="Moment ..."
                                                                                                      readonly>
                                                                                                    Ampere
                                                                                                </div>
                                                                                            </div>
                                                                                    ...
                                                                                    <div class="col-sm-6">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-sm-3">
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                    <label>Moment (Ampere)</label>
                                                                                                    <input type="number" class="form-control" value="{{ $dat->sar_fasa_gfr_hasil_moment_a }}" name="sar_fasa_gfr_hasil_moment_a"
                                                                                                      placeholder="Moment (Ampere) ..." readonly>
                                                                                                    Ampere
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-sm-3">
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                    <label>Moment (detik)</label>
                                                                                                    <input type="number" class="form-control" value="{{ $dat->sar_fasa_gfr_hasil_moment_det }}" name="sar_fasa_gfr_hasil_moment_det"
                                                                                                      placeholder="Moment (detik) ..." readonly>
                                                                                                    detik
                                                                                                </div>
                                                                                            </div>
                                            ...
                                            <div class="modal fade" id="modal-delete-{{ $dat->id }}" style="display: none;" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content bg-danger">
                                                        ...
                                                        <form role="form" method="POST" action="{{ route('data.penghantar.destroy', $dat->id) }}">
                                                            @csrf
                                                            {{ method_field('DELETE') }}
